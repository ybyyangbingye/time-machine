...
public class LocationServiceImpl implements LocationService {
    ...
    @Override
    public JSONArray searchPosByPoint(String key, String location, Integer page_size, Integer page_index) throws Exception {
    ...
    @Override
    public JSONArray searchPosByKeyWord(String key, String location, String keyword, Integer page_size, Integer page_index) throws Exception {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        StringBuilder sb = new StringBuilder();
